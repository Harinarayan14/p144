...
export default class HomeScreen extends Component {
  ...
  getArticle = () => {
    const url = "http://6ef2de267e8d.ngrok.io/get-article";
    axios
      .get(url)
      .then(response => {
  ...
  likedArticle = () => {
    const url = "http://6ef2de267e8d.ngrok.io/liked-article";
    axios
      .post(url)
      .then(response => {
        this.getArticle();
  ...
  dislikedArticle = () => {
    const url = "http://6ef2de267e8d.ngrok.io/disliked-article";
    axios
      .post(url)
      .then(response => {
        this.getArticle();
